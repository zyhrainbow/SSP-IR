...
def code_backup(args):
    ...
    ignore_patterns = shutil.ignore_patterns("*.pyc", "__pycache__", "results", "cache", "*.csv", "slurm_logs", "wandb", "temp_results", "*.log", "cache", "experiment", "experiments","figs","preset", "ram", "scripts", "tb_logger")
    shutil.copytree("./", code_path, ignore=ignore_patterns)
