...
class LLavaAgent:
    def __init__(self, model_path, device='cuda', conv_mode='vicuna_v1'):
        ...
        # qs = ["Please provide a detailed description of the picture, excluding any mention of weather conditions.",
        #     "Describe the contents of the image in depth, avoiding references to the weather.",
        #     "Offer a comprehensive description of the picture, leaving out details related to weather.",
        #     "Detail the elements of the image without including any information about the weather.",
        #     "Give a thorough description of what's in the picture, omitting weather-related details.",
        #     "Explain what the image depicts, but do not mention any weather conditions.",
        #     "Illustrate the details of the picture without referring to the weather.",
        #     "Convey a detailed account of the image, excluding weather descriptions.",
        #     "Narrate what is present in the image, deliberately leaving out the weather.",
        #     "Provide an in-depth analysis of the picture's contents, with no reference to the weather.",]
        # self.qs = np.random.choice(qs) 
        self.qs = 'Describe the image in a very detailed manner if we remove the degradation artifacts from the image.'
