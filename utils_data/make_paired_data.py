...
parser.add_argument("--gt_path", nargs='+', default=['/media/ps/ssd2/zyh/dataset/lsdir_val1/HR/val/'], help='the path of high-resolution images')
parser.add_argument("--save_dir", type=str, default='/media/ps/ssd2/zyh/dataset/sr_realesrgan/LSDIR_VAL_2K', help='the save path of the training dataset.')
parser.add_argument("--start_gpu", type=int, default=6, help='if you have 5 GPUs, you can set it to 1/2/3/4/5 on five gpus for parallel processing., which will save your time. ')  
...
step = 0#len(train_dataset) * epochs * args.start_gpu
with torch.no_grad():
