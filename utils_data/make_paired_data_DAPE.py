...
parser.add_argument("--gt_path", nargs='+', default=["/media/ps/ssd2/zyh/dataset/LSDIR/"], help='the path of high-resolution images')
parser.add_argument("--save_dir", type=str, default='/media/ps/ssd2/zyh/dataset/sr_realesrgan/testing_lsdir/', help='the save path of the training dataset.')
